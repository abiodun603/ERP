...
import { TopNavNotificationItem, TopnavUser, TopNavWrapper} from './style-topnav'
...
import { user_menu } from '../../utils/ui-data'
      ...
      <TopNavWrapper>
        ...
        <div className = "left_Topnav">
          ...
          <div className='search'>
            ...
            <BiSearchAlt className='topnav_search'/>
          </div>
          {/* dropdown */}
          <div className='dropdown_select'>
            <span className='select'>All  Categories</span>
            <MdKeyboardArrowDown className='dropdown_icon'/>
          </div>
        </div>
        ...
        <div className = "right_Topnav">
          ...
          />
          {/* setting */}
          <FiSettings className='right_Topnav-setting hover:scale-150'/>
        </div>
      </TopNavWrapper>
    </>
  )
